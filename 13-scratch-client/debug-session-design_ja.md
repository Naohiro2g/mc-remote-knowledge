...
学習者は「動いた／動かない」は目で見えるが、「**なぜ**動かないか」が見えない。言語力（とくにエラーの言語化）を最重視する本プロジェクトの哲学（[ai-learning-design](../20-教材/ai-learning-design_ja.md)）からすると、これは致命的な欠落。エラーの言語化は言語力訓練の宝庫。
...
[ai-learning-design](../20-教材/ai-learning-design_ja.md) §5・§7 の「組み込み型 AI は範囲を制御できる層で生きる」が、ここで論理的に成立する。
...
→ [ai-learning-design](../20-教材/ai-learning-design_ja.md) §4「AI を言語化の壁打ち相手として使う」「なぜ?と問い返す」設計の、理想的な最初の実験場。
...
- [ai-learning-design](../20-教材/ai-learning-design_ja.md) §7「導入の段階論」の A→B のうち、ここが B の最初の着地点になりうる。
