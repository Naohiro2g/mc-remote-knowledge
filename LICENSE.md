...
この repository は、著作物の性質に応じてライセンスを分けます（決定 `2026-07-21-02`）。

- オリジナルの Markdown 文書、図、教育資料: [Creative Commons Attribution-ShareAlike 4.0 International](LICENSES/CC-BY-SA-4.0.txt)
- 独立して利用できる source code、script、tool、hook: [MIT License](LICENSES/MIT.txt)
