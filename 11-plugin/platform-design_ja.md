...
このprefix切替とprotocol 23 registry cleanupを含む現行McRemote sourceは
`codex/b6-protocol23-cleanup@88d818703be5e7314bc1e45597a66237796db641`で実装済みcandidateである。
...
`world.spawnEntity`、handle registry、availability等のb5共通基盤は維持する。Scratch owner fixture二件を
