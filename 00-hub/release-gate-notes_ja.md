...
- non-claim: Scratch sign／browser保存のexact integrated artifact、set 3 exact WireScope pause、Bridge dependency-complete公開package、公開release artifact freeze、default branch統合、b6 `GREEN`／releaseを主張しない
