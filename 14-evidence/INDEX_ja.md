...
| `2026-07-28-scratch-showcase-failclose` | `unit/deterministic` + `live-auto` + `live-human` | Scratch showcase 二重 guard: build 時 `disableMcRemoteConnection()` ラッチ＋runtime `connection_enabled`、拒否理由 `connection_disabled` 統一 | [record](records/2026-07-28-scratch-showcase-failclose_ja.md) | なし（sanitized counts を record に直接収録） | `19790d9e58d0dc1aafe907486bdd7cfbde28d316` |
